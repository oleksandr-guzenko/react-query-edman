...
function Search() {
  ...
  return (
    <div className="py-4 px-2">
      <div className="text-muted mb-5">Enter a what you have eaten, like "coffee and croissant" or "chicken enchilada" to see how it works. We have accurate data tens of thousands of foods, including international dishes.</div>
